...
| Attachments | Small files are stored inline as base64 text | Medium now, High later | Move production attachments to Supabase Storage. |
...
3. Confirm login, question submit, answer save, admin user update, team chat, and notifications.
