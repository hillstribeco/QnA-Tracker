...
3. Check `public/config.js` has the correct Supabase URL, anon key, and primary admin email.
4. Deploy this repository to Netlify with publish directory `public`.
